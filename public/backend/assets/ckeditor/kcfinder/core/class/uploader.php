...
/** Opener applocation properties_old
  * @var array */
...
/** Next three properties_old are got from the current language file
  * @var string */
...
/** Magic method which allows read-only access to protected or private class properties_old
