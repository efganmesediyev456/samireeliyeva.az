    ...
    $("body").on("click",'.edit', function (e){
        ...
        $.ajax({
            ...
            success:function (json){
                withoutTranslate("#title-edit",json.title, json);
                withoutTranslate("#link-edit",json.link, json);
                $("#image-edit").siblings('img').remove();
                $("#image-edit").after('<img width="300px" class="my-3" src="/storage/'+json.image+'">')
