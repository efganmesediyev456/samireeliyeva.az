...
$("body").on("click",'.edit', function (){
    ...
    $.ajax({
        ...
        success:function (e){
            ...
            $('#updatemodal input[name="full_name"]').val(e.item.full_name);

            $('#updatemodal input[name="email"]').val(e.item.email);

            $('#updatemodal select[name="type"]').val(e.item.type).trigger("change");


            $("#updatemodal .updateroles").val(e.item.front_roles).trigger('change');
