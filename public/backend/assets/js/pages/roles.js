...
$("body").on("click",'.edit', function (){
    ...
    $.ajax({
        ...
        success:function (e){
            ...
            $("#updatemodal .form-check input.form-check-input").prop('checked', false)
            ...
            $('#updatemodal input[name="guard_name"]').val(e.item.guard_name);

            for(a in e.item.permissions){
                console.log(e.item.permissions[a].id)
            }
            $("#updatemodal select[name='permissions[]']").val(e.permissions).trigger('change');
