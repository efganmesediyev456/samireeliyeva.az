        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <h4>İnşa Nümunəsi Düzəliş -
                        {{ $subcategories->translate() ? $subcategories->translate()->title : 'N/A' }}</h4>
                    <div class="buttons">
                        <a href="{{ route('admin.subcategories.essay-examples.index', $subcategories->id) }}"
            ...
            <div class="card-body">
                <form action="{{ route('admin.subcategories.essay-examples.update', [$subcategories->id, $item->id]) }}"
                            ...
                            <div class="tab-pane fade show @if ($loop->first) active @endif"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12" @if ($item->type == 2) style="display:none" @endif>
                                        <div class="mb-3">
                                            <label for="description_{{ $language->code }}" class="form-label">Haqqında
                                                {{ $language->code }}</label>
                                            <textarea class="form-control ckeditor" name="description[{{ $language->code }}]"
                                                id="description_{{ $language->code }}" placeholder="" value="">{{ $item->translate($language->code)?->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="files-container">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="file" name="update_files[{{ $index }}]"
                                                            class="form-control">
                                                        <small class="text-muted">Fayl dəyişdirmək istəmirsinizsə boş
                                                            buraxın</small>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                @else
                                    <div class="file-row mb-4 p-3 border rounded">
                                        ...
                                        <div class="text-end mt-2">
                                            <button type="button" class="btn btn-sm btn-danger remove-new-file"
