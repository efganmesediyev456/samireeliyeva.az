    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h4>Yeni İnşa Nümunəsi - {{ $subcategories->translate() ? $subcategories->translate()->title : 'N/A' }}</h4>
                <div class="buttons">
                    <a href="{{ route('admin.subcategories.essay-examples.index', $subcategories->id) }}" class="gap-2 btn btn-success d-flex align-items-center">
        ...
        <div class="card-body">
            <form action="{{ route('admin.subcategories.essay-examples.store', $subcategories->id) }}" method="POST" id="saveForm" enctype="multipart/form-data">
                @csrf
