        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <h4>Yeni İmtahan Kateqoriyası</h4>
                    <div class="buttons">
                        <a href="{{ route('admin.subcategories.exam-categories.index',$subcategories->id) }}"
            ...
            <div class="card-body">
                <form action="{{ route('admin.subcategories.exam-categories.store', $subcategories->id) }}" method="POST" id="saveForm">
                    @csrf
