    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h4>Yeni Kiçik Video Rolik- {{ $subcategories->translate() ? $subcategories->translate()->title : 'N/A' }}</h4>
                <div class="buttons">
                    <a href="{{ route('admin.subcategories.little-video-rolics.index', $subcategories->id) }}" class="gap-2 btn btn-success d-flex align-items-center">
                        
                        <i class="fas fa-arrow-left"></i>
                        <span style="width: max-content">Geriyə qayıt</span>
                        </a>
                </div>
            </div>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.subcategories.little-video-rolics.store', $subcategories->id) }}" method="POST" id="saveForm" enctype="multipart/form-data">
                @csrf
