    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h4>Qalereya Videosu</h4>
                <div class="buttons">
                    <a href="{{ route('admin.gallery-videos.index') }}" class="btn btn-success">
        ...
        <div class="card-body">
            <form action="{{route('admin.gallery-videos.update', $item->id)}}" method="POST" id="saveForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-header">
                                <h5>Çoxlu Videolar</h5>
                            </div>
                            <div class="card-body">
                                <div class="mb-3">
                                    <label for="media_files" class="form-label">Videolar Əlavə Et</label>
                                    <input type="file" name="media_files[]" class="form-control" multiple accept="video/*">
                                    <small class="text-muted">Birdən çox video seçə bilərsiniz (mp4, avi, mov, wmv, webm)</small>
                                </div>
                                
                                <!-- Existing Media Files -->
                                @if($item->media && $item->media->count() > 0)
                                <div class="mt-4">
                                    <h6>Mövcud Videolar</h6>
                                    <div class="row">
