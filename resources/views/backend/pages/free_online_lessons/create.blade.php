    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="buttons">
                    <a href="{{ route('admin.free_online_lessons.index') }}" class="btn btn-success">
        ...
        <div class="card-body">
            <form action="{{route('admin.free_online_lessons.store')}}" method="POST" id="saveForm" enctype="multipart/form-data">
                @csrf
