    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h4>Vacib Link</h4>
                <div class="buttons">
                    <a href="{{ route('admin.important_links.index') }}" class="btn btn-success">
        ...
        <div class="card-body">
            <form action="{{route('admin.important_links.update', $item->id)}}" method="POST" id="saveForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            @if($item->image)
                                <img width="200" src="/storage/{{$item->image}}" alt="">
                            @endif
                            <small class="text-muted">Link şəkli yükləyin</small>
                        </div>
                    </div>
                </div>
