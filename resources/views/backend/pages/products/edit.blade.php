                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="pick_of_status" class="form-control" id="">
                                <option value="0" @selected($item->pick_of_status==0)>Xeyr</option>
                                <option value="1" @selected($item->pick_of_status==1)>Bəli</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="sub_category_id" class="form-control" id="">
                                ...
                                <option @selected($item->sub_category_id==$category->id) value="{{$category->id}}">{{$category->title}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="brand_id" class="form-control" id="">
                                ...
                                <option @selected($item->brand_id==$brand->id) value="{{$brand->id}}">{{$brand->title}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
