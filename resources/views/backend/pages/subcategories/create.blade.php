    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h4>Alt Kateqoriya</h4>
                <div class="buttons">
                    <a href="{{ route('admin.subcategories.index') }}" class="btn btn-success">
        ...
        <div class="card-body">
            <form action="{{route('admin.subcategories.store')}}" method="POST" id="saveForm" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select name="category_id" id="category_id" class="form-control">
                                ...
                                @foreach($categories as $category)
                                    <option value="{{ $category->id }}">{{ $category->translate() ? $category->translate()->title : 'N/A' }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
