        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <h4>Yeni İmtahan statusu</h4>
                    <div class="buttons">
                        <a href="{{ route('admin.subcategories.exam-statuses.index',$subcategories->id) }}"
            ...
            <div class="card-body">
                <form action="{{ route('admin.subcategories.exam-statuses.store', $subcategories->id) }}" method="POST" id="saveForm">
                    @csrf
