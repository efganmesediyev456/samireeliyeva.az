...
class GalleryVideosDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($item) {
                return view('backend.pages.gallery-videos.actions', compact('item'), [
                    'editRoute' => route('admin.gallery-videos.edit', $item->id),
                    'deleteRoute' => route('admin.gallery-videos.destroy', $item->id),
                ]);
            })
    ...
    public function query(GalleryVideo $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('gallery-videos-table')
                        ...
                        if (data.length) {
                            $.ajax({
                                ...
                                data: {
                                    ...
                                    items: data,
                                    model:'".addslashes(GalleryVideo::class)."'
                                },
