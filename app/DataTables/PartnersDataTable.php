    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($item) {
                return view('backend.pages.partners.actions', compact('item'), [
                    'editRoute' => route('admin.partners.edit', $item->id),
                    'deleteRoute' => route('admin.partners.destroy', $item->id),
                ]);
            })
                        ...
                        if (data.length) {
                            $.ajax({
                                ...
                                data: {
                                    ...
                                    items: data,
                                    model:'".addslashes(Partner::class)."'
                                },
