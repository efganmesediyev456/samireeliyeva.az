    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($item) {
                return view('backend.pages.services.actions', compact('item'), [
                    'editRoute' => route('admin.services.edit', $item->id),
                    'deleteRoute' => route('admin.services.destroy', $item->id),
                ]);
            })
                        ...
                        if (data.length) {
                            $.ajax({
                                ...
                                data: {
                                    ...
                                    items: data,
                                    model:'".addslashes(Service::class)."'
                                },
