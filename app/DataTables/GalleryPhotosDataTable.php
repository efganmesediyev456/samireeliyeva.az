...
class GalleryPhotosDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($item) {
                return view('backend.pages.gallery-photos.actions', compact('item'), [
                    'editRoute' => route('admin.galleryphotos.edit', $item->id),
                    'deleteRoute' => route('admin.galleryphotos.destroy', $item->id),
                ]);
            })
    ...
    public function query(GalleryPhoto $model): QueryBuilder
    {
