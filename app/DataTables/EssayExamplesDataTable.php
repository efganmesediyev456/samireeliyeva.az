...
class EssayExamplesDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($item) {
                return view('backend.pages.essay-examples.actions', compact('item'), [
                    'editRoute' => route('admin.subcategories.essay-examples.edit', [$this->subcategory->id, $item->id]),
                    'deleteRoute' => route('admin.subcategories.essay-examples.destroy', [$this->subcategory->id, $item->id]),
                ]);
            })
    ...
    public function query(EssayExample $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('essay-examples-table')
                        ...
                        if (data.length) {
                            $.ajax({
                                ...
                                data: {
                                    ...
                                    items: data,
                                    model:'".addslashes(EssayExample::class)."'
                                },
    ...
    {
        return 'EssayExamples_' . date('YmdHis');
    }
}