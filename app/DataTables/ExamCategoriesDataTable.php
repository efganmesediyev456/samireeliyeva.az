...
class ExamCategoriesDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($item) {
                return view('backend.pages.exam_categories.actions', compact('item'), [
                    'editRoute' => route('admin.subcategories.exam-categories.edit', [$this->subcategory->id, $item->id]),
                    'deleteRoute' => route('admin.subcategories.exam-categories.destroy', [$this->subcategory->id, $item->id]),
                ]);
            })
    ...
    {
        return $this->builder()
            ->setTableId('exam-categories-table')
                        ...
                        if (data.length) {
                            $.ajax({
                                ...
                                data: {
                                    ...
                                    items: data,
                                    model:'".addslashes(ExamCategory::class)."'
                                },
    ...
    {
        return 'ExamCategories_' . date('YmdHis');
    }
}