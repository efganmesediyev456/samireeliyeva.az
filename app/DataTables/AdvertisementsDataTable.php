    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($item) {
                return view('backend.pages.advertisements.actions', compact('item'), [
                    'editRoute' => route('admin.advertisements.edit', $item->id),
                    'deleteRoute' => route('admin.advertisements.destroy', $item->id),
                ]);
            })
                        ...
                        if (data.length) {
                            $.ajax({
                                ...
                                data: {
                                    ...
                                    items: data,
                                    model:'".addslashes(Advertisement::class)."'
                                },
